...
game.SpendGold= Object.extend({
  ...
  startBuying: function(){ this.buying = true; me.state.pause(me.state.PLAY);
  ...
  draw: function(renderer){
    ...
    this.font.draw(renderer.getContext(),"W Ability: Chomp-Chomp Current Level: " + game.data.ability2 + " Cost: " + ((game.data.ability2+1)*10), this.pos.x, this.pos.y + 200);
    this.font.draw(renderer.getContext(),"E Ability: Spear Throw Current Level:" + game.data.ability3 + " Cost: " + ((game.data.ability3+1)*10), this.pos.x, this.pos.y + 240);
